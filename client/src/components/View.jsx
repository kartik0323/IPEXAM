     ...
     <div className="container bg-gray-300 w-full h-[100vh] flex justify-center items-center">
      <div className="bg-stone-300 flex flex-col justify-between py-4 items-start border-2 border-double border-pink-500 w-[20vw] px-7 h-[50vh]">
        ...
        <div className="name w-full py-2">
           <h3 className='font-bold text-lg text-blue-600'>STUDENT: <span className='pl-5 text-pink-500'>{record.name}</span></h3>
        </div>
         
        <div className="email py-2">
        <h3 className='font-bold text-lg text-blue-600'>PERCENTAGE: <span className='pl-5 text-pink-500'>{record.fname}</span></h3>
        </div>
       
       <div className="address py-2">
       <h3 className='font-bold text-lg text-blue-600'>STANDARD: <span className='pl-5 text-pink-500'>{record.work}</span></h3>
       </div>

       <div className="contact py-2">
       <h3 className='font-bold text-lg text-blue-600'>ACTIVITY: <span className='pl-5 text-pink-500'>{record.nationality}</span></h3>
       </div>
       <div className="contact py-2">
       <h3 className='font-bold text-lg text-blue-600'>ADDRESS: <span className='pl-5 text-pink-500'>{record.salary}</span></h3>
       </div>
